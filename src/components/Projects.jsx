      ...
      <div style={{
        ...
        <div style={{ flex: '1 1 360px', minWidth: 0 }}>
          ...
          <div style={{
            ...
            color: isEven ? 'rgba(247,245,240,0.5)' : '#66635F',
          ...
          <p style={{
            ...
            fontWeight: 300,
            color: isEven ? 'rgba(247,245,240,0.6)' : '#66635F',
            marginBottom: '1.5rem',
          ...
          <p style={{
            ...
            lineHeight: 1.8,
            color: isEven ? 'rgba(247,245,240,0.72)' : '#66635F',
          ...
          <div style={{
            ...
            marginBottom: '1.75rem',
            paddingTop: '1.25rem',
            borderTop: `1px solid ${isEven ? 'rgba(247,245,240,0.12)' : '#E7E2DA'}`,
          }}>
            {[
              ...
              <div key={label}>
                ...
                <div style={{
                  ...
                  fontSize: '0.78rem',
                  fontWeight: 500,
                  color: isEven ? 'rgba(247,245,240,0.75)' : '#66635F',
                  lineHeight: 1.4,
                  maxWidth: 130,
                }}>{value}</div>
              </div>
            ...
            {[project.stat1, project.stat2].map((s) => (
              <div key={s.label}>
                ...
                <div style={{
                  ...
                  letterSpacing: '0.18em',
                  textTransform: 'uppercase',
                  color: isEven ? 'rgba(247,245,240,0.45)' : '#66635F',
                  marginTop: '0.3rem',
                }}>{s.label}</div>
              </div>
            ))}
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '2rem' }}>
            {project.tags.map((tag) => (
              <span key={tag} style={{
                ...
                borderRadius: 999,
                background: isEven ? 'rgba(247,245,240,0.1)' : 'rgba(23,23,23,0.07)',
                color: isEven ? 'rgba(247,245,240,0.7)' : '#66635F',
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        inset: 0,
        background: `
          linear-gradient(180deg, rgba(23,23,23,0.4) 0%, rgba(23,23,23,0.25) 35%, rgba(23,23,23,0.55) 65%, #F7F5F0 100%),
